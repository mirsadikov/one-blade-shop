const razorsList = document.querySelector('#razors .products__list');
const skincareList = document.querySelector('#skincare .products__list');
const accessoriesList = document.querySelector('#accessories .products__list');
